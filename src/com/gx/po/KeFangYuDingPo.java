...
/*--------------------------------------------  预定旅客ID end ------------------------------------------------------------*/
	...
	public Integer getRoomGuestRoomLevelID() {
			...
			public void setPassengerLicenceIssuingAuthorty(String passengerLicenceIssuingAuthorty) {
			...
			public void setPredeterminePassengerWhereToGo(String predeterminePassengerWhereToGo) {
