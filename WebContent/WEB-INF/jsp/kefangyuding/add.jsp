 ...
 <script type="text/javascript">
   ...
   function selectRoom(){
    ...
    $.ajax({                                                      
          ...
          url: '${ctx}/kefangyuding/selectRoom.do',       //地址 type 带参数
...
//        dataType:"json",                                       // json 数据类型提交 
   ...
   function addfunction(){
     ...
     form1.action="${ctx}/kefangyuding/add.do?id="+id+"&type="+teamId+"&roomIdShuZu="+roomIdShuZu;
     form1.submit();
   }
   
   function lastStep(){
     parent.document.getElementById('Mainid').src='${ctx}/kefangyuding/tolist.do';
   }
