				...
				<ul class="nav nav-list">
					...
					<li>
						<a id="stayManageId" onclick="stayManage()" class="dropdown-toggle">
							<i class="icon-move"></i>
							<span class="menu-text">特色菜品管理 </span>
					...
					<li>
						...
						<i class="icon-dashboard"></i>
							<span class="menu-text">餐桌预定管理 </span>
							<b class="arrow icon-angle-down"></b>
						</a>
						<ul class="submenu">
							<li>
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			function dateView(){
			     ...
			     document.getElementById('Mainid').src='${ctx}/canzhuoyuding/tolist.do';
			}
			...
			function passengerInformation(){
			     ...
			     document.getElementById("smallGuide").innerHTML=s+"";
			     document.getElementById('Mainid').src='${ctx}/kehuxinxi/tolist.do';
			}
			function receiveTarget(){
			     ...
			     document.getElementById("smallGuide").innerHTML=s+"";
			     document.getElementById('Mainid').src='${ctx}/jiedaiduixiang/tolist.do';
			}
			...
			function roomSet(){
			     ...
			     document.getElementById("smallGuide").innerHTML=s+"";
			     document.getElementById('Mainid').src='${ctx}/kefang/tolist.do';
			}
			function commoditySet(){
			     ...
			     document.getElementById("smallGuide").innerHTML=s+"";
			     document.getElementById('Mainid').src='${ctx}/goods/tolist.do';
			}
			...
			function reservations(){
			     ...
			     document.getElementById("smallGuide").innerHTML=s+"";
			     document.getElementById('Mainid').src='${ctx}/kefangyuding/tolist.do';
			}
			function personage(){
			     var a=document.getElementById("stayManageId").getElementsByTagName('span')[0].innerHTML;
			     document.getElementById("bigGuide").innerHTML=a+"";
