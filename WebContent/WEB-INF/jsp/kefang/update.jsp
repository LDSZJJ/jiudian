...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container">
    ...
    <form action="${ctx}/kefang/update.do" method="post" onsubmit="return verify()">
 ...
 <script type="text/javascript">
    ...
    function deletefunction(){
     parent.document.getElementById('Mainid').src='${ctx}/kefang/tolist.do';
   }
   ...
   function YZ(value){
     if(value!=""){
       $.ajax({                                                      
          ...
          url: '${ctx}/kefang/YZ.do',       //地址 type 带参数
