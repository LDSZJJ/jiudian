...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;">
    <div class="span5">
	    <div class="row-fluid">
		    ...
		    <form action="${ctx}/kefang/tolist.do" method="post" style="float: left;">
 ...
 <script type="text/javascript">
   function addfunction(){
     parent.document.getElementById('Mainid').src='${ctx}/kefang/toadd.do';
   }
   ...
   var chk_value=[];
  	...
  	if(chk_value!=""){
		if(chk_value.toString().indexOf(",")>0){
		   ...
		   parent.document.getElementById("Mainid").src='${ctx}/kefang/toupdate.do?id='+chk_value;
		}
	}else{
	  alert("请选择一条数据进行修改");
	}
   ...
   var chk_value=[];
     ...
     if(flag){
  	  parent.document.getElementById("Mainid").src='${ctx}/kefang/delete.do?id='+chk_value;
  	}
  	}else{
...
//        dataType:"json",                                       // json 数据类型提交 
   ...
   $(".tcdPageCode").createPage({
     ...
     location.href="${ctx}/kefang/tolist.do?currentPage="+p+"&txtname="+txtname;
     }
   });
