...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" >
    <div class="span5">
	    <div class="row-fluid">
		    ...
		    <form action="${ctx}/jiedaiduixiang/tolist.do" method="post" style="float: left;">
 ...
 <script type="text/javascript">
   function addfunction(){
     parent.document.getElementById('Mainid').src='${ctx}/jiedaiduixiang/toadd.do';
   }
   ...
   var chk_value=[];
  	...
  	if(chk_value!=""){
		if(chk_value.toString().indexOf(",")>0){
		   ...
		   parent.document.getElementById("Mainid").src='${ctx}/jiedaiduixiang/toupdate.do?id='+chk_value;
		}
	}else{
	  alert("请选择一条数据进行修改");
	}
   ...
   var chk_value=[];
     ...
     if(flag){
  	  parent.document.getElementById("Mainid").src='${ctx}/jiedaiduixiang/delete.do?id='+chk_value;
  	}
  	}else{
  ...
  $(".tcdPageCode").createPage({
     ...
     location.href="${ctx}/jiedaiduixiang/tolist.do?currentPage="+p+"&txtname="+txtname;
     }
   });
