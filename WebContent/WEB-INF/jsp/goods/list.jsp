...
<div/>
 ...
 <script type="text/javascript">
   function addfunction(){
     parent.document.getElementById('Mainid').src='${ctx}/goods/toadd.do';
   }
   ...
   var chk_value=[];
  	...
  	if(chk_value!=""){
		if(chk_value.toString().indexOf(",")>0){
		   ...
		   parent.document.getElementById("Mainid").src='${ctx}/goods/toupdate.do?id='+chk_value;
		}
	}else{
	  alert("请选择一条数据进行修改");
	}
   ...
   var chk_value=[];
     ...
     if(flag){
  	  parent.document.getElementById("Mainid").src='${ctx}/goods/delete.do?id='+chk_value;
  	}
  	}else{
   ...
   function selectChange(){
     ...
     parent.document.getElementById('Mainid').src='${ctx}/goods/tolist.do?commodityTypeID='+commodityTypeID;
   }
   ...
   $(".tcdPageCode").createPage({
     ...
     var commodityTypeID=document.getElementById("selectCboId").value;
     location.href="${ctx}/goods/tolist.do?currentPage="+p+"&txtname="+txtname+"&commodityTypeID="+commodityTypeID;
     }
   });
   ...
   function selectFunction(){
     var txtname=document.getElementById("txtnameid").value;
     var commodityTypeID=document.getElementById("selectCboId").value;
     parent.document.getElementById('Mainid').src='${ctx}/goods/tolist.do?commodityTypeID='+commodityTypeID+'&txtname='+txtname;
   }
   
   
   function newaddfunction(){
   var txtname=document.getElementById("newtxtnameid").value;
     parent.document.getElementById('Mainid').src='${ctx}/goods/newadd.do?txtname='+txtname;
   }
   ...
   var chk_value=[];
  	...
  	var flag=window.confirm("注意：您确定要永久删除该信息吗?");
     if(flag){
  	  parent.document.getElementById("Mainid").src='${ctx}/goods/newdelete.do?id='+chk_value;
  	}
  	}else{
	  alert("请选择一条或多条数据进行删除");
	}
