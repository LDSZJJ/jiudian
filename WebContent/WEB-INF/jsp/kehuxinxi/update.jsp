...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;">
    ...
    <form action="${ctx}/kehuxinxi/update.do" method="post" onsubmit="return verify()">
    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
 ...
 var Name=document.getElementById("papersNumberId").value;
    ...
    function deletefunction(){
     parent.document.getElementById('Mainid').src='${ctx}/kehuxinxi/tolist.do';
   }
   ...
   function YZ(value){
     if(value!=""){
       $.ajax({                                                      
          ...
          url: '${ctx}/kehuxinxi/YZ.do',       //地址 type 带参数
