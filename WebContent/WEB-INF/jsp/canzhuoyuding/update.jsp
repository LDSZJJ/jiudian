...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">预定修改</h3>
      </div>
    </div>
    
    <form action="${ctx}/canzhuoyuding/update.do" method="post" onsubmit="return verify()">
	    <input type="hidden" name="id" value="${listPo.id}">
	    <div class="span12">
	     <div class="row-fluid">
		      <div class="span5">
			   	  <label class="labelroomnumber">预定桌号：</label>
			      <input id="TableNumberId" name="TableNumber" class="textone inputone" value="${listPo.tableNumber}"
	    ...
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span5">
			      ...
			      <input id="PassengerNameId" name="PassengerName" class="textone inputone" value="${listPo.passengerName}"
			       style="height:26px;" type="text" onchange="onchangeOne()" onblur="YZ(this.value)">
			      <div id="divOne">
			         <label class="yansered" style="margin-top:18px;">*</label>
			       </div>
			  ...
			  <div class="span5">
			   ...
			   <div class="span5">
			        ...
			        <input id="DateId" name="Date" type="text" style="height:26px;" placeholder="年-月-日" value="${listPo.date}"> 
			      <div id="divOne">
			         <label class="yansered" style="margin-top:18px;">*</label>
			       </div>
			  </div> 
   ...
   function YZ(value){
     if(value!=""){
       $.ajax({                                                      
          ...
          url: '${ctx}/goods/YZ.do',       //地址 type 带参数
