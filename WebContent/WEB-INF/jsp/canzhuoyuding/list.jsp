...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" >
    <div class="span4">
	    <div class="row-fluid">
		    <label class="labelroomnumber" style="font-size:16px;">预定桌号：</label>
    ...
    <div class="span6">
      <div class="row-fluid">
      <label class="labelroomnumber" style="font-size:16px;">餐桌类型：</label>
       <div class="span5">
         <select id="selectCboId" name="TableTypeID" class="dgvone" style="width:40%;" onchange="selectChange()">
            <c:forEach items="${listOne}" var="item">
	          <option value="${item.far_id}" <c:if test="${item.far_id==tableType}">selected="selected"</c:if>>
    ...
    <div class="dgvone">
       <table class="table table-condensed table-bordered table-striped" id="tableid">
	      <thead class="theadone">
	        <tr>
	          <th rowspan="2">选择</th>
	          <th rowspan="2">预定桌号</th>
	          <th rowspan="2">预订人姓名</th>
	          <th rowspan="2">预订时间</th>
	      </thead>
	      <tbody id="tbody">
...
<div/>
 ...
 <script type="text/javascript">
   function addfunction(){
     parent.document.getElementById('Mainid').src='${ctx}/canzhuoyuding/toadd.do';
   }
   ...
   var chk_value=[];
  	...
  	if(chk_value!=""){
		if(chk_value.toString().indexOf(",")>0){
		   ...
		   parent.document.getElementById("Mainid").src='${ctx}/canzhuoyuding/toupdate.do?id='+chk_value;
		}
	}else{
	  alert("请选择一条数据进行修改");
	}
   ...
   var chk_value=[];
     ...
     if(flag){
  	  parent.document.getElementById("Mainid").src='${ctx}/canzhuoyuding/delete.do?id='+chk_value;
  	}
  	}else{
   ...
   function selectChange(){
     var TableTypeID=document.getElementById("selectCboId").value;
     parent.document.getElementById('Mainid').src='${ctx}/canzhuoyuding/tolist.do?TableTypeID='+TableTypeID;
   }
   ...
   $(".tcdPageCode").createPage({
     ...
     var TableTypeID=document.getElementById("selectCboId").value;
     location.href="${ctx}/canzhuoyuding/tolist.do?currentPage="+p+"&txtname="+txtname+"&TableTypeID="+TableTypeID;
     }
   });
   ...
   function selectFunction(){
     var txtname=document.getElementById("txtnameid").value;
     var TableTypeID=document.getElementById("selectCboId").value;
     parent.document.getElementById('Mainid').src='${ctx}/canzhuoyuding/tolist.do?TableTypeID='+TableTypeID+'&txtname='+txtname;
   }
   
   
   function newaddfunction(){
   var txtname=document.getElementById("newtxtnameid").value;
     parent.document.getElementById('Mainid').src='${ctx}/canzhuoyuding/newadd.do?txtname='+txtname;
   }
   ...
   var chk_value=[];
  	...
  	var flag=window.confirm("注意：您确定要永久删除该信息吗?");
     if(flag){
  	  parent.document.getElementById("Mainid").src='${ctx}/canzhuoyuding/newdelete.do?id='+chk_value;
  	}
  	}else{
	  alert("请选择一条或多条数据进行删除");
	}
