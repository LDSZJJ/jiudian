...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">餐桌预定</h3>
      </div>
    </div>
    
    <form action="${ctx}/canzhuoyuding/add.do" method="post" onsubmit="return verify()">
	    <div class="span12">
	      <div class="row-fluid">
		      <div class="span5">
			   	  <label class="labelroomnumber">预定桌号：</label>
			      <input id="TableNumberId" name="TableNumber" class="textone inputone"
			  ...
			  <div class="span5 ">
			   	  <label class="labelroomnumber">餐桌类型：</label>
			      <select name="TableTypeID" class="cboone inputone">
		            <c:forEach items="${listOne}" var="item">
			          <option value="${item.far_id}" <c:if test="${item.far_id==18}" >selected="selected"</c:if>>
	    ...
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span5">
			   	  <label class="labelroomnumber">预定人姓名：</label>
			      <input id="PassengerNameId" name="PassengerName" class="textone inputone"
			       style="height:26px;" type="text" onchange="onchangeOne()" onblur="YZ(this.value)">
			      <div id="divOne">
			         <label class="yansered" style="margin-top:18px;">*</label>
			       </div>
			  ...
			  <div class="span5">
			   ...
			   <div class="span5">
			   	  <label class="labelroomnumber">预定时间：</label>
			        <input id="hDateId" name="Date" type="text" style="height:26px;" placeholder="年-月-日"> 
			      <div id="divOne">
			         <label class="yansered" style="margin-top:18px;">*</label>
			       </div>
			  </div> 
 ...
 <script type="text/javascript">
    ...
    function deletefunction(){
     parent.document.getElementById('Mainid').src='${ctx}/canzhuoyuding/tolist.do';
   }
   ...
   function YZ(value){
     if(value!=""){
       $.ajax({                                                      
          ...
          url: '${ctx}/canzhuoyuding/YZ.do',       //地址 type 带参数
          data:"TableNumber="+value,                         // IDCardValue 自定义的。相当于name把值赋予给 他可以在servlet 获取
          async:false,                                          // 是否 异步 提交
          success: function (result) {                          // 不出现异常 进行立面方
              if(result>=1){                                  
                   alert("已存在此商品名称，请另取商品名称！");                     //提示框
                   document.getElementById("TableNumberId").value="";     //这个id的文本框的值 将会清空
                   document.getElementById("TableNumberId").focus();      // 给这个id的文本框提供焦点
                   document.getElementById("divOne").style.display="block"; //显示
              }else{ }
          },
          error: function(data) { }
